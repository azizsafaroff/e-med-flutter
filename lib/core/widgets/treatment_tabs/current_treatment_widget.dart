...
class CurrentTreatmentsWidget extends StatelessWidget {
  const CurrentTreatmentsWidget({Key? key}) : super(key: key);
          ...
          if (snapshot.data.docs.isEmpty) {
            return Column(
              ...
              children: [
                ...
                Center(
                  child: EmedText(
                    text: "You haven't done any treatments yet",
                    size: 16.0,
                  ),
                ),
